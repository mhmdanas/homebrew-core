class Theora < Formula
  ...
  stable do
    url "https://downloads.xiph.org/releases/theora/libtheora-1.1.1.tar.xz", using: :homebrew_curl
    mirror "https://ftp.osuosl.org/pub/xiph/releases/theora/libtheora-1.1.1.tar.xz"
